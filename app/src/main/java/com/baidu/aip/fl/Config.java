...
public class Config {
    ...
    public static String apiKey = "uQYZijuItaYdI3PV0oHWZUGS";
    public static String secretKey = "CMhNbAVAYqpIxFZG81IQevGoMfQUGU97";
    public static String licenseID = "yibashipad2-face-android";
    ...
    public static String groupID = "oldman";
