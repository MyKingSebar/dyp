package v1.cn.unionc_pad.view.PickerUI;
...
//                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        mPickerUIListView2 = (PickerUIListView) view.findViewById(R.id.picker_ui_listview2);
        mPickerUIListView3 = (PickerUIListView) view.findViewById(R.id.picker_ui_listview3);
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        if (typedArray != null) {
            try {
                ...
                if (idItems != -1) {
                    setItems(mContext, Arrays.asList(getResources().getStringArray(idItems)),1);
                }
    ...
    public void setItemsClickables(boolean itemsClickables) {
        ...
        } if (mPickerUIListView2 != null && mPickerUIListView2.getPickerUIAdapter() != null) {
            mPickerUIListView2.getPickerUIAdapter().setItemsClickables(itemsClickables);
        } if (mPickerUIListView3 != null && mPickerUIListView3.getPickerUIAdapter() != null) {
            mPickerUIListView3.getPickerUIAdapter().setItemsClickables(itemsClickables);
        }
    }
    ...
    public void setColumn(int num){
        if(num==1){
            mPickerUIListView.setVisibility(VISIBLE);
            mPickerUIListView2.setVisibility(GONE);
            mPickerUIListView3.setVisibility(GONE);
        }else if(num == 2){
            mPickerUIListView.setVisibility(VISIBLE);
            mPickerUIListView2.setVisibility(VISIBLE);
            mPickerUIListView3.setVisibility(GONE);
        }else if(num ==3){
            mPickerUIListView.setVisibility(VISIBLE);
            mPickerUIListView2.setVisibility(VISIBLE);
            mPickerUIListView3.setVisibility(VISIBLE);
        }
    }
     ...
     */
    public void setItems(Context context, List<String> items, int num) {
        if (items != null) {
            setItems(context, items, 0, items.size() / 2,num);
        }
    }
     ...
     * @param position the position to set in the center of the panel.
     */
    public void setItems(Context context, List<String> items, int which, int position, int num) {
        if (items != null) {
            this.items = items;
            if(num==1)
            mPickerUIListView.setItems(context, items, which, position, itemsClickables);
            if(num==2)
            mPickerUIListView2.setItems(context, items, which, position, itemsClickables);
            if(num==3)
            mPickerUIListView3.setItems(context, items, which, position, itemsClickables);
    ...
    public void setColorTextCenter(int color) {
        if (mPickerUIListView != null && mPickerUIListView.getPickerUIAdapter() != null) {
            ...
            mColorTextCenterListView = newColor;
            mPickerUIListView2.getPickerUIAdapter().setColorTextCenter(newColor);
        }  if (mPickerUIListView3 != null && mPickerUIListView3.getPickerUIAdapter() != null) {
            ...
            mColorTextCenterListView = newColor;
            mPickerUIListView3.getPickerUIAdapter().setColorTextCenter(newColor);
        }
    }
    ...
    public void setColorTextNoCenter(int color) {
        if (mPickerUIListView != null && mPickerUIListView.getPickerUIAdapter() != null) {
            ...
            mColorTextNoCenterListView = newColor;
            mPickerUIListView2.getPickerUIAdapter().setColorTextNoCenter(newColor);
        } if (mPickerUIListView3 != null && mPickerUIListView3.getPickerUIAdapter() != null) {
            int newColor;
            try {
                newColor = getResources().getColor(color);
            ...
            mColorTextNoCenterListView = newColor;
            mPickerUIListView3.getPickerUIAdapter().setColorTextNoCenter(newColor);
        }
    }
        ...
        bottomUp.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                if (mPickerUIListView != null && mPickerUIListView.getPickerUIAdapter() != null) {
                    ...
                    mPickerUIListView2.getPickerUIAdapter().handleSelectEvent(position + 2);
                    mPickerUIListView2.setSelection(position);
                }  if (mPickerUIListView3 != null && mPickerUIListView3.getPickerUIAdapter() != null) {
                    mPickerUIListView3.getPickerUIAdapter().handleSelectEvent(position + 2);
                    mPickerUIListView3.setSelection(position);
                }
            }
     ...
     */
    public void setOnClickItemPickerUIListener(final PickerUIItemClickListener listener,final PickerUIItemClickListener listener2,final PickerUIItemClickListener listener3) {
        this.mPickerUIListener = listener;
        this.mPickerUIListener2 = listener2;
        this.mPickerUIListener3 = listener3;
        ...
        mPickerUIListView2.setOnClickItemPickerUIListener(
                new PickerUIListView.PickerUIItemClickListener() {
                    @Override
                    public void onItemClickItemPickerUI(int which, int position,
                            String valueResult) {
                        ...
                        if (mPickerUIListener2 == null) {
                            throw new IllegalStateException(
                                    "You must assign a valid PickerUI.PickerUIItemClickListener first!");
                        }
                        mPickerUIListener2.onItemClickPickerUI(which, position, valueResult);
                    }
                });
        mPickerUIListView3.setOnClickItemPickerUIListener(
                new PickerUIListView.PickerUIItemClickListener() {
                    @Override
                    public void onItemClickItemPickerUI(int which, int position,
                            String valueResult) {
                        ...
                        if (mPickerUIListener3 == null) {
                            throw new IllegalStateException(
                                    "You must assign a valid PickerUI.PickerUIItemClickListener first!");
                        }
                        mPickerUIListener3.onItemClickPickerUI(which, position, valueResult);
                    }
                });
    }
