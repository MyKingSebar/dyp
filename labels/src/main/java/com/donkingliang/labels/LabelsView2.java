...
public class LabelsView2 extends ViewGroup implements View.OnClickListener {
    ...
    public LabelsView2(Context context) {
        super(context);
        mContext = context;
    }

    public LabelsView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        getAttrs(context, attrs);
    }

    public LabelsView2(Context context, AttributeSet attrs, int defStyleAttr) {
